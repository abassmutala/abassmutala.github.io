...
export const projectsConfig: { projects: Project[] } = {
    projects: [
        ...
        },
        {
            ...
            description:"Web application for exporting data from Firebase Firestore database to JSON, and converting that data into .xlsx format for viewing in a spreadsheet.",           image: "/alpha_bank.png",
            // backgroundColor: "linear-gradient(120deg, #2d2b26, #4d122f)",//"#F1F5FD",
            // backgroundColor: "#FFFFFF",
            backgroundColor: "rgb(185 28 28)",
            textColor: "#FFFFFF",
        ...
        },
        {
            ...
            image: "/glico_stores_android.png",
